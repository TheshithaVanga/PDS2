...
diabetes = read.csv("C:\\Users\\vanga\\OneDrive\\Desktop\\PDS-2\\clean_data\\diabetes.csv")
diabetes
...
barplot(stats, main="Comparison of Glucose Statistics", ylab="Glucose", col=c("blue", "yellow", "blue", "yellow"), ylim=c(0, 250))
...
hist(bmi, breaks=20, xlab="BMI", main="BMI Distribution for Population",col="lightyellow",border = "black")
abline(v=data_98th_percentile, col="yellow", lty=2)
...
abline(v=samp_98th_percentile, col="blue", lty=2)
